...
export const DEV_VERSION = '14.1.0.2'; // nicodrag versioning // [total amount of updates].[Major].[minor].[changes/commits since last minor/major version change]

export const DATE_VERSION = '1/??/2025';
export const DATE_DEV_VERSION = '9/28/2024';

export const VERSION_LABEL = 'scripts/version.js fix';
